// FULL CREDIT TO: "github.com/go-cmd/cmd" for this masterpiece
...
func (c *Cmd) Stop() error {
	...
	switch runtime.GOOS {
	case "windows":
		return terminateProcessWindows(c.status.PID)
	case "darwin":
		// MAC?
		//return terminateProcessDarwin(c.status.PID)
	default: // "linux", "freebsd", "openbsd", "netbsd"
		//return terminateProcessLinux(c.status.PID)
	}
	return nil
...
func (c *Cmd) run(in io.Reader) {
	...
	switch runtime.GOOS {
	case "windows":
		setProcessGroupIDWindows(cmd)
	case "darwin":
		// MAC?
		//setProcessGroupIDDarwin(cmd)
	default: // "linux", "freebsd", "openbsd", "netbsd"
		//setProcessGroupIDLinux(cmd)
	}
