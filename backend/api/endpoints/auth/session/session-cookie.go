...
func generateSessionToken() (string, error) {
	b, err := generateRandomBytes(32) // Adjust token length as per your requirements
	if err != nil {
		return "", err
	}
...
func createSessionCookie(w http.ResponseWriter, sessionToken string) {
...
func Active(w http.ResponseWriter, r *http.Request) (string, error) {
	_, err := r.Cookie("my_little_session_cookie")
	if err != nil {
		return "inactive", err
	}
	return "active", nil
...
func Create(w http.ResponseWriter, r *http.Request, userID string) (any, error) {
	...
	createSessionCookie(w, sessionToken)
